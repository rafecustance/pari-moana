...
const CONTENT = {
  ...
  body: 'Living and entertaining unfold across a series of connected spaces, both inside and out. Sheltered, flexible and carefully scaled, the home supports everything from quiet evenings to generous gatherings, with light, warmth and outlook shaping the experience throughout the day.',
};
